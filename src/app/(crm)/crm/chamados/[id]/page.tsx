      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[12px] text-on-surface-variant/60">
            {TIPO_CHAMADO[ordem.tipo] ?? ordem.tipo} · #{id.slice(-8)}
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          {ordem.notas.map(nota => (
            <Card key={nota.id} className="border-amber-500/20 bg-amber-500/5 p-5 rounded-[16px] shadow-sm">
              <div className="mb-3 flex items-center gap-2">
                <span className="material-symbols-outlined text-[18px] text-amber-600/70">lock</span>
                <span className="text-[12px] font-semibold text-amber-700">Nota interna</span>
                <span className="ml-auto text-[11px] text-on-surface-variant/50">
          ...
          <Card className="border-outline-variant/15 bg-card/60 p-5 rounded-[16px] shadow-sm">
            ...
            <dl className="space-y-2.5 text-[13px]">
              ...
              <div>
                ...
                <dd className="text-on-surface">{TIPO_CHAMADO[ordem.tipo] ?? ordem.tipo}</dd>
              </div>
              <div>
