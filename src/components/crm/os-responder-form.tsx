...
export function OSResponderForm({ ordemId, clienteId, statusAtual, temResposta, clienteNome, clienteEmail, clienteWpp, socios = [] }: Props) {
  ...
  const hasChanges  = resposta.trim() || hasAnexo || novoStatus !== statusAtual
