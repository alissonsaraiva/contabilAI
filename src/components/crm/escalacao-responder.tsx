      ...
      <div className="rounded-[14px] border border-outline-variant/15 bg-card p-6 shadow-sm space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            ...
            />
            {/* Botões de anexo — apenas no modo direto WhatsApp */}
            {podeAnexar && (
              <div className="absolute bottom-2.5 right-2 flex items-center gap-1">
                ...
                <button
                  ...
                  disabled={uploading}
                  className="flex h-8 w-8 items-center justify-center rounded-lg text-on-surface-variant/50 hover:bg-surface-container hover:text-on-surface disabled:opacity-40 transition-all"
