...
const criarChamadoTool: Tool = {
  definition: {
    name: 'criarChamado',
    description:
      'Cria um chamado no sistema. Use quando: cliente solicitar algo no WhatsApp, IA precisar delegar uma tarefa a um humano, operador criar uma tarefa interna. Substitui criarTarefa.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  meta: {
    label: 'Criar chamado',
    descricao: 'Cria um chamado vinculado ao cliente — substitui criarTarefa. Aceita origem cliente, IA ou operador.',
    categoria: 'Chamados',
...
registrarTool(criarChamadoTool)
