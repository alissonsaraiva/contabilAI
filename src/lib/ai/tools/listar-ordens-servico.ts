...
const listarOrdensServicoTool: Tool = {
  definition: {
    name: 'listarOrdensServico',
    description: 'Lista os chamados (ordens de serviço) abertos pelos clientes via portal. Filtra por status (aberta, em_andamento, aguardando_cliente, resolvida, cancelada) ou por cliente. Use para ver a fila de suporte, checar se um cliente tem chamados em aberto, ou relatório de atendimentos.',
    inputSchema: {
      type: 'object',
      properties: {
        clienteId: {
...
registrarTool(listarOrdensServicoTool)
